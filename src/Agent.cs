...
namespace TimHanewich.AgentFramework
{
    public class Agent
    {
        ...
        //Events
        public event ExecutableActionHandler? ExecutableFunctionInvoked;      //It evoked a function
        public event ExecutableActionHandler? ExecutableFunctionReturned;     //An executable function that was invoked (called) returned
